...
![Google AI StudioのトップページでGet startedボタンをクリックする](./guide-20260809-075012.png)

2. ご利用いただくGoogleアカウントでログインする（求められた場合）

![Googleアカウントのログイン画面](./guide-20260809-075104.png)

3. Google AI Studioに最初にアクセスすると、ようこそのダイアログが表示されます。利用規約やプライバシーポリシーを確認し、チェックを入れた後、**［続行］**を押下します。

![AI Studioへようこそダイアログで利用規約に同意して続行をクリック](./guide-20260809-075210.png)


4. 画面左ペインの**［Dashboard］**をクリックします。

![画面左ペインのDashboardメニュー](./guide-20260809-075500.png)

5. 画面右上の**［APIキーを作成］**をクリックします。

![APIキー一覧画面でAPIキーを作成ボタンをクリック](./guide-20260809-075811.png)


6. ダイアログが表示されたら、**［キー名の設定］**のラベルに適当な文字列（"YouTube Movie AI Summary"など）を入力します。その後、**［キーを作成］**を押下します。

![新しいキーを作成するダイアログでキー名を入力してキーを作成](./guide-20260809-080008.png)

7. 数秒でキーが発行されるので、表示された**［API キー］**の文字列をコピーしてください。文字列の右側にあるコピーボタンをクリックすると便利です。

![発行されたAPIキーをコピーする](./guide-20260809-080442.png)
...
![YouTube動画ページ右下の⋮ボタン](./guide-20260809-081201.png)

2. メニューから **［⚙ 設定］** を選ぶ

![⋮メニューから⚙設定を選択](./guide-20260809-081324.png)

3. **［APIキー］**欄の **［変更］** ボタンを押す

![設定画面のAPIキー欄で変更ボタンを押す](./guide-20260809-081353.png)

4. APIキーの入力を求められます。セットアップの手順でコピーしたAPIキーを貼り付けて**［OK］**を押下します。

![APIキー入力ダイアログにキーを貼り付ける](./guide-20260809-081657.png)

5. 「APIキーを保存しました。」と表示されれば完了です。**［OK］**を押下して、ダイアログを閉じます。

![APIキーを保存しましたのメッセージ](./guide-20260809-081733.png)

6. APIキーの欄で「設定済み（APIキー）」が表示されているのを確認したら、画面右上の**［✕］**ボタンを押下して、ポップアップを閉じます。

![設定画面でAPIキーが設定済みになっていることを確認](./guide-20260809-081917.png)

### 3. 要約を試してみる

1. 動画ページで **［🔎 簡単に要約］** ボタンを押下し、生成中となるので、待ちます。

![簡単に要約ボタンを押して要約を生成中の画面](./guide-20260809-082112.png)

![要約準備中のポップアップ](./guide-20260809-082117.png)

2. しばらく待つと、要約結果がポップアップで表示されます。

![要約結果が表示されたポップアップ](./guide-20260809-082145.png)
...
![APIキー一覧から該当のキーをクリックして再表示する](./guide-20260809-085448.png)
...
![Google AI Studioのレート制限画面](./guide-20260809-083523.png)
...
![詳細に解説ボタンを押した結果の表示例](./guide-20260809-082918.png)
...
![音楽演奏動画に対する要約結果の例](./guide-20260809-082621.png)
...
![カスタムプロンプトの新規作成画面](./guide-20260809-083203.png)

![カスタムプロンプトを使った要約結果の例](./guide-20260809-083223.png)